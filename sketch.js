...
function setup() {
 ...
 console.log(message)
  ...
  ground = createSprite(displayWidth/2,displayHeight/2 + 200,800,20);
  ...
  invisibleGround = createSprite(displayWidth/2-600,displayHeight/2+200,400,20);
...
function draw() {
  ...
  //displaying score
  textSize(40);
  text("Score: "+ score, displayWidth/2-100, displayHeight/3);
...
function spawnObstacles(){
 if (frameCount % 80 === 0){
   var obstacle = createSprite(displayWidth,displayHeight/2+180,10,40);
